...
<head>
    ...
    <title>Bengkel Mobil Beteng Betawi - <?php echo $__env->yieldContent('title'); ?></title>
    ...
    <footer class="bg-gray-900 text-white mt-16">
        <div class="container mx-auto px-4 py-12">
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
                <p>&copy; <?php echo e(date('Y')); ?> Bengkel Mobil Beteng Betawi. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\xampp\htdocs\BengkelBeteng\resources\views/layouts/app.blade.php ENDPATH**/ ?>