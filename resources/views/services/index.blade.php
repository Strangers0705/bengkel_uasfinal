...
@section('title', 'Layanan Kami - Bengkel Mobil Beteng Betawi')
                    ...
                    <div class="p-6">
                        <div class="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center mb-4">
                            <span class="text-blue-700 text-xl w-8 h-8 flex items-center justify-center mx-auto">
                                <span class="w-6 h-6">{!! $service->icon !!}</span>
                            </span>
                        </div>
                        <h3 class="text-xl font-semibold mb-2">{{ $service->name }}</h3>
                        <p class="text-gray-600 mb-4">{{ $service->description }}</p>
                        <div class="flex items-center justify-between">
                            <p class="text-sm text-gray-500">Mulai dari {{ $service->price_range }}</p>
                            <a href="{{ route('services.show', $service) }}" class="text-blue-700 hover:text-blue-800 font-medium flex items-center">
                                Detail
