        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-gray-50 rounded-lg shadow-sm overflow-hidden team-card">
                    <img src="https://images.pexels.com/photos/{{ $person['img'] }}/pexels-photo-{{ $person['img'] }}.jpeg?auto=compress&cs=tinysrgb&w=800"
                         alt="{{ $person['nama'] }}"
                         class="w-full object-cover object-center">
                    <div class="p-6">
                        <h3>{{ $person['nama'] }}</h3>
                        <p class="text-blue-700 mb-3">{{ $person['posisi'] }}</p>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="overflow-hidden rounded-lg shadow-md">
                    <img src="https://images.pexels.com/photos/{{ $item['img'] }}/pexels-photo-{{ $item['img'] }}.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                         alt="{{ $item['title'] }}"
